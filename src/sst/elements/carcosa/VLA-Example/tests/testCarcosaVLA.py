...
full_exe_name = os.getenv("VANADIS_EXE", "./vla")
...
decoderParams = {"loader_mode": os.getenv("VANADIS_LOADER_MODE", "0"), "uop_cache_entries": 1536, "predecode_cache_entries": 4}
osHdlrParams = {}
...
class CPU_Builder:
    ...
    def build(self, prefix, nodeId, cpuId):
        ...
        link_hali_dtlb.connect((hali, "lowlink", "1ns"), (dtlbWrapper, "highlink", "1ns"))
        link_hali_dtlb.setNoCut()

        link_cpu_l1dcache_link = sst.Link(prefix + ".link_cpu_l1dcache_link")
        link_cpu_l1dcache_link.connect((dtlbWrapper, "lowlink", "1ns"), (cpu_l1dcache, "highlink", "1ns"))
        ...
        link_cpu_l1icache_link.connect((itlbWrapper, "lowlink", "1ns"), (cpu_l1icache, "highlink", "1ns"))
