...
class FaultInjCPU : public SST::Component {
public:
...
SST_ELI_DOCUMENT_PORTS(
    ...
    //SST_ELI_DOCUMENT_SUBCOMPONENT_SLOTS( { "HaliConnection", "Interface to manage backing", "SST::Carcosa::HaliComponent" } )
...
private:
    ...
    double currentFaultRate;  // Cycles from 0.1 to 1.0
