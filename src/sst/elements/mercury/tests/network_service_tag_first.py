...
processor = router.setSubComponent(
    "network_service", "merlin.network_service_pr2_processor"
)

source = sst.Component("source", "merlin.network_service_pr2_endpoint")
source.addParam("id", 0)
...
for endpoint_id, network_if in enumerate((source_if, mercury_if)):
