  ...
  public CollectiveEndpointProvider
{
 public:
  ...
  SST_ELI_DOCUMENT_PARAMS(
    ...
    {"collective_submit_delay_ns", "Additional collective launch delay before host memory staging", "0"},
    {"collective_completion_delay_ns", "Additional collective completion delay after host memory staging", "0"}
  )
...
private:
  ...
  uint64_t collective_submit_delay_ns_ = 0;
  uint64_t collective_completion_delay_ns_ = 0;
