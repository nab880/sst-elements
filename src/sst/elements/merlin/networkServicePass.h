...
/**
 * Merlin-owned processor used to validate transparent tagged carriage.  It
 * advertises a service ID so endpoints can negotiate it, owns no VN, and
 * therefore lets every tagged packet route as ordinary traffic.
 */
