...
class Job(Buildable):
    ...
    def setEndpointNIC(self, endpointNIC):
...
# A helper function to serialize a routing table entry (for source routing)
def serialize_routing_entry(routing_table_src_entry, source_router_id):
    ...
    Returns:
        str: Serialized routing table string from this router as source.
    """
    dest_parts = []
