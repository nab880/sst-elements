/* Raptor BSP-visible subset; exact silicon and full interrupt topology are unspecified. */
...
/* Cacheable P1/P2 data uses aliases above 4 GiB; fetch, loading, DMA and uncached data use raw RAM. */
                                                  ...
                                                  bool strict_mmio)
{
    ...
    /* These reviewed devices have no parent bus, so QOM ownership alone does not enroll them in the machine reset tree. */
