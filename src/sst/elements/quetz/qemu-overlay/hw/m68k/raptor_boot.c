/* Functional boot: -kernel loads ELF; explicit -bios uses big-endian SP/PC vectors, without a silicon reset-source claim. */
                      ...
                      M68kCPU *cpu, hwaddr rom_base, uint64_t rom_size)
{
    ...
    if (machine->firmware) {
        ...
        /* Dual-core images are confined to P1/P2 respectively; reject primary segments outside P1. */
