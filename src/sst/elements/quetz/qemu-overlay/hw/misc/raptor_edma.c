/* Functional eDMA: BSP 5.7.0 registers, MCF54455RM ch.19 transfers; RAM/ROM reads and RAM writes only. */
                        ...
                        bool write)
{
    ...
    /* Validate plain RAM/ROM first; MMIO and RAM-device callbacks can have side effects. */
...
{
    /* Accept only the register widths exercised by the BSP driver. */
