// Unit tests for the device-side radix-2 FFT (quetz_fft.h) that quetz.FFTKernel runs.
...
// Zero nontrivial twiddles to prove the reference vector detects this FFT mutation.
