...
# Disable legacy payload forwarding: this native self-test has no SST peripheral.
...
# Capture native UART1 writes without routing them through RAM timing.
...
# Observe native peripherals; strict QEMU MMIO owns access validation.
