/* Exercise BSP GPIO readback with 16-bit masked value and plain direction stores. */
...
/* Read-modify-write, plain 8-bit store (matches GPIO_set_direction). Returns 1 if the masked readback matches. */
