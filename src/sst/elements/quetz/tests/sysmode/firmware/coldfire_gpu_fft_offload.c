/* Device-side FFT with matched big-endian window bytes; the FPU-less guest compares IEEE bits. */
...
void kernel_main(void)
{
    ...
    /* Nonblocking submission exercises STATUS polling; blocking submission is already complete. */
