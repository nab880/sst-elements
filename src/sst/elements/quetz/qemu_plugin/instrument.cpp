...
static void cb_cache_op(unsigned vi, void* userdata)
{
    ...
    // Reject non-supervisor cache operations before modeling instructions QEMU would fault.
    ...
    // Acknowledge maintenance before later window MMIO; ordinary trace traffic has separate ordering.
