# Contract test: malloc+free on coherent memHierarchy.Bus (Quetz P3 topology).
# Run: sst testBalar-coherent-bus.py --model-options='-c gpu-v100-mem.cfg -s stats.out -x ./balar_trace/vectorAdd -t traces/malloc_free.trace'
...
cpu, _ = balar_test_topology.build_testcpu_coherent_bus(
