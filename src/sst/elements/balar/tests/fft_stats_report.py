...
#
# Host metrics come from the DoorbellTestCPU / memHierarchy stats; GPU metrics
...
# DoorbellTestCPU and memHierarchy; we sum the Sum.u64 field across matching lines.
HOST_STATS = [
