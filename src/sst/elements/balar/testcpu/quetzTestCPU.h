...
#ifndef BALAR_QUETZ_TEST_CPU_H
#define BALAR_QUETZ_TEST_CPU_H
...
// TODO: forked from BalarTestCPU per the "do not modify BalarTestCPU" constraint.
// The trace parser, packet-issue state machine, and packet helpers are duplicated;
// refactor to a shared base class once the Quetz contract is stable.
class QuetzTestCPU : public SST::Component {
public:
    SST_ELI_REGISTER_COMPONENT(
        ...
        "Quetz-pattern test CPU: cache_link for scratch+flush, mmio_link for GPU doorbell",
    ...
    QuetzTestCPU(SST::ComponentId_t id, SST::Params& params);
...
private:
    ...
    // TODO: redundant with stat_cuda_calls_completed_->getCollectionCount();
