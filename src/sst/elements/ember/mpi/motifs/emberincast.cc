...
{
	// nsx: terminal reporting call -- the target prints per-iteration incast
	// latency (start/stop captured via enQ_getTime around the iterations).
	...
	// nsx: capture stop time after the final iteration; the next (terminal)
	// call prints + returns true.
